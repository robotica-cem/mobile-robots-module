...
\begin{frame}[label={sec:orgfcb6850}]{Control en lazo abierto}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
 \includegraphics[width=1.0\linewidth]{../figures/unicycle-model}
...
\begin{frame}[label={sec:org67b598f}]{Implementación del control en lazo abierto}
Simulink
\end{frame}
\end{document}