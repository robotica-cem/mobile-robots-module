...
#+title:  El modelo canónical de robots móviles no-holonómicos
# #+date: 2018-04-05
...
** Modelo canónical a.k.a modelo uniciclo
    ...
    \footnotesize
    From Martina Zambelli (2013) /Posture regulation for unicycle-like robots with prescribed performance guarantees/. KTH - Royal Institute of Technology, Sweden.
...
:END:
    ...
    \begin{center}
     \includegraphics[width=1.0\linewidth]{../figures/bicycle-model}
    \end{center}
